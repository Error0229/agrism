...
interface QuickAddFABProps {
  ...
  /** Whether the sheet should be open (controlled from parent) */
  open?: boolean
...
export function QuickAddFAB({
  ...
  }, [title, selectedType, selectedFieldId, selectedCropId, farmId, onCreate, setOpen])
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="bottom" className="rounded-t-2xl max-h-[85vh]" showCloseButton={false}>
          ...
          <div className="space-y-4 px-4 pb-4">
            ...
            {/* Crop selector pills (show top 8) */}
            {crops.length > 0 && (
              <div className="space-y-1.5">
